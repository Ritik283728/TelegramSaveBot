...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐", url="https://t.me/Vzzzzboooot3bot")]]), reply_to_message_id=message.id)
...
bot.send_message(message.chat.id,f"Error :  {e}", reply_to_message_id=message.id)					bot.send_message(message.chat.id,f"**", reply_to_message_id=message.id)
						continue
				except pyrogram.errors.exceptions.TelegramError as e:
					bot.send_message(message.chat.id,f"**", reply_to_message_id=message.id)
						continue				
